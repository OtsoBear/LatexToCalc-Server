const fonts = {
	...
	datrixcode: {
		glyphMSDFURL: "assets/coptic_msdf.png", // Use working coptic font temporarily
		glyphSequenceLength: 32,
		glyphTextureGridSize: [8, 8], // Regular grid layout
	},
	greek: {
		glyphMSDFURL: "assets/greek.png",
		glyphSequenceLength: 26, // a-z characters
		glyphTextureGridSize: [7, 4], // 7x4 = 28 slots for 26 characters
	},
};
...
const defaults = {
	...
	cycleSpeed: 0.04, // The speed glyphs change
	...
	glyphEdgeCrop: 0.04, // The border around a glyph in a font texture that should be cropped out
